  ...
  themeConfig: {
    ...
    sidebar: [
      { text: 'arXiv review', collapsed: false, items: [
        ...
        { text: '2026-03-08-固体物理', link: '/phys/2026-03-08' },
        { text: '2026-03-09-固体物理', link: '/phys/2026-03-09' },
        { text: '2026-03-10-固体物理', link: '/phys/2026-03-10' },
        { text: '2026-03-10-計算物質科学', link: '/calc/2026-03-10' },
        { text: '2026-03-10-マテリアルズ・インフォマティクス', link: '/mi/2026-03-10' },
        { text: '2026-03-11-固体物理', link: '/phys/2026-03-11' },
        { text: '2026-03-11-計算物質科学', link: '/calc/2026-03-11' },
        { text: '2026-03-11-マテリアルズ・インフォマティクス', link: '/mi/2026-03-11' },
        { text: '2026-03-12-計算物質科学', link: '/calc/2026-03-12' },
        { text: '2026-03-12-マテリアルズ・インフォマティクス', link: '/mi/2026-03-12' },
        { text: '2026-03-14-計算物質科学', link: '/calc/2026-03-14' },
        { text: '2026-03-14-マテリアルズ・インフォマティクス', link: '/mi/2026-03-14' },
        { text: '2026-03-15-固体物理', link: '/phys/2026-03-15' },
        { text: '2026-03-15-計算物質科学', link: '/calc/2026-03-15' },
        { text: '2026-03-15-マテリアルズ・インフォマティクス', link: '/mi/2026-03-15' },
        { text: '2026-03-16-固体物理', link: '/phys/2026-03-16' },
        { text: '2026-03-16-計算物質科学', link: '/calc/2026-03-16' },
        { text: '2026-03-16-マテリアルズ・インフォマティクス', link: '/mi/2026-03-16' },
        { text: '2026-03-17-固体物理', link: '/phys/2026-03-17' },
        { text: '2026-03-17-計算物質科学', link: '/calc/2026-03-17' },
        { text: '2026-03-17_1-計算物質科学', link: '/calc/2026-03-17_1' },
        { text: '2026-03-17-マテリアルズ・インフォマティクス', link: '/mi/2026-03-17' },
        { text: '2026-03-18-固体物理', link: '/phys/2026-03-18' },
        { text: '2026-03-18-計算物質科学', link: '/calc/2026-03-18' },
        { text: '2026-03-18-マテリアルズ・インフォマティクス', link: '/mi/2026-03-18' },
        

        { text: '固体物理', collapsed: false, items: [
          { text: '2026-03-08-固体物理', link: '/phys/2026-03-08' },
          { text: '2026-03-09-固体物理', link: '/phys/2026-03-09' },
          { text: '2026-03-10-固体物理', link: '/phys/2026-03-10' },
          { text: '2026-03-11-固体物理', link: '/phys/2026-03-11' },
