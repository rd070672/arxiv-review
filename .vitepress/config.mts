    ...
    sidebar: [
      ...
      { text: 'April, 2026', collapsed: true, items: [
        ...
        { text: '2026-03-28', collapsed: true, items: [
          { text: '軌道交替磁性体の電子構造', link: '/review/2603/2026-03_orbital-altermagnetism' },
          { text: '強誘電体における超高速光-電子-フォノン相互作用', link: '/review/2603/2026-03_ultrafast-ferroelectric-phonons' },
          { text: 'カイラルフォノンの軌道熱電変換', link: '/review/2603/2026-03_phonon-orbital-seebeck' },
          { text: '軌道交替磁性体の平坦バンド', link: '/topic/2603/2026-03_altermagnet-CrSb-flatband' },
        ]},

        { text: '2026-03-25', collapsed: true, items: [
          { text: 'PXRDと深層学習を用いた材料解析', link: '/review/2603/2026-03_PXRD-deep-learning' },
          { text: '超高速熱力学', link: '/review/2603/2026-03_ultrafast-phonon-thermodynamics' },
          { text: '高エントロピーセラミックス', link: '/review/2603/2026-03_ultrafast-sintering-HEC' },
          { text: 'ゲートモン量子ビット', link: '/review/2603/2026-03_ultrastrong-coupling-gatemon' },
        ]},

        { text: '2026-03-24', collapsed: true, items: [
          { text: 'アモルファス固体のエネルギー地形', link: '/review/2603/2026-03_amorphous-energy-landscape' },
          { text: 'フェリ磁性の磁壁ダイナミクス', link: '/review/2603/2026-03_domain-wall-dynamics-ferrimagnet' },
          { text: '電子テスラバルブ', link: '/review/2603/2026-03_electron-tesla-valve' },
          { text: 'ユニバーサルMLIPによる電解質のイオン輸送', link: '/review/2603/2026-03_universal-MLIP-electrolyte' },
          { text: '破壊力学のマルチスケールシミュレーション', link: '/review/2603/2026-03_fracture-mechanics-multiscale-simulation' },
          { text: 'Kitaevスピンガラス', link: '/review/2603/2026-03_kitaev-spin-glass' },
        ]},

        { text: '2026-03-23', collapsed: true, items: [
          { text: '交替磁性のトポロジカル物性', link: '/review/2603/2026-03_hall-altermagnet' },
          { text: 'カゴメ平坦バンド共鳴', link: '/review/2603/2026-03_kagome-flat-band-resonance' },
          { text: '強誘電性p波磁性体', link: '/review/2603/2026-03_p-wave-magnet' },
          { text: 'TaIrTe4超格子メモリ', link: '/review/2603/2026-03_TaIrTe4-superlattice-memory' },
          { text: 'UTe2多成分超伝導体', link: '/review/2603/2026-03_UTe2-multicomponent-SC' },
          { text: '双層ニッケル酸化物の半ドーム特性', link: '/review/2603/2026-03_bilayer-nickelate-halfdome' },
          { text: '化学組成の最適化によるFeTe超伝導体', link: '/review/2603/2026-03_stoichiometric-FeTe-superconductor' },
          { text: 'モアレ・マグノニクス', link: '/review/2603/2026-03_moire-magnonics-superlattice' },
          { text: '2D応力変換器', link: '/review/2603/2026-03_2D-strain-transformer' },
          { text: 'GeO2のフォノン輸送', link: '/review/2603/2026-03_GeO2-phonon-transport' },
          { text: '原子電子トモグラフィーのML解析', link: '/review/2603/2026-03_low-dose-AET-PANN' },
        ]},
