...
- **Primary broad area**: フォノン・熱輸送
- **Secondary broad area**: 材料創製・プロセス
- **注目論文**: arXiv:2603.18885
- **参照した関連論文数**: 6本
- **選定理由**: 直近9記事でフォノン・熱輸送分野がまったくカバーされておらず、多様性の観点から優先度が高い。超広バンドギャップ半導体の熱管理という実用的に重要なテーマでありながら、T^{-1.4}という謎の温度依存性を手がかりに、フォノン散乱の基礎理論まで展開できる点で、記事としての構成しやすさも高い。
