# 2次元材料のひずみ空間をTransformerで駆け抜ける：機械学習が解き明かす力学と電子物性の結びつき

**執筆日**: 2026-03-23
**トピック**: 2次元材料のひずみエンジニアリングにおける解釈可能なTransformerサロゲートモデル
**Primary broad area**: 計算材料科学
**Secondary broad area**: 電子構造・物性物理
**注目論文**: 2603.20141
**参照した関連論文数**: 7本
**選定理由**: 直近の記事はスピン機能材料・超伝導・トポロジカル絶縁体に集中しており、計算材料科学・マテリアルズインフォマティクスの分野が空白になっていた。本論文は2D材料の多次元ひずみ空間をTransformerで探索するという新しいアプローチを示しており、話題性と分野多様性の両面から最適な選定である。
