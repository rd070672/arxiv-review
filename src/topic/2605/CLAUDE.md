...
CLAUDE.md の指示に従い、arXiv cond-mat recent を起点として最近注目される話題を1つ選び、日本語で学部4年生向けの「図入り特集解説記事」を Markdown で作成すること。その際、reported_papers.csv を全て参照し、anchor 論文は原則除外するように気を付けてください。
