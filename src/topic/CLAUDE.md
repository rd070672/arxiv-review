...
## 候補選定
--------------------------------
- reported_papers.csv を参照し、既報論文は原則除外する
...
--------------------------------
各候補に以下を付与すること。
- main-area: 材料創製・プロセス / 構造・組織 / 電子構造 / 磁性・スピン / 半導体・電子材料 / 超伝導・強相関 / フォノン・熱 / 非平衡・動的応答 / 計算・理論 / 計測・分光 / デバイス・機能 / マルチフィジックス・連成現象
- sub-area: 1〜2個
- method-tag: 任意で1〜2個
...
- main_area は上記の main-area の英語対応表現を記入すること
- sub_area は上記の sub-area の英語対応表現を記入すること
- method_tag は上記の method-tag の英語対応表現を記入すること
